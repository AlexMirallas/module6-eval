<main class="container">
  <?php var_dump($data_form)?>;
  <h1>Editer l'info de <span class="fs-1 text-muted"><?php echo $data_form["nom"] . " " . $data_form["prenom"]?></span></h1>
    <form class="mt-4" method="POST">
      ...
      <div data-mdb-input-init class="form-outline mb-4">
        <textarea type="text" id="cv" class="form-control overflow-auto" name="cv" rows="10" value="<?php echo $data_form["cv"] ?>" ></textarea>
        <label class="form-label" for="cv">CV <span class="text-muted">(max 65000 chars)</span></label>
      </div>
      <div class="mb-3 form-check">
        <input type="checkbox" class="form-check-input" id="role" name="isAdmin" value="<?php $data_form["isAdmin"] === true ? "checked" : "" ?>"/>
